                    ...
                    <div class="flat-header-wrap">
                      ...
                      <div class="nav-wrap">
                        ...
                        <nav id="mainnav" class="mainnav">
                            <ul class="menu">
                                <li >
                                    <a href="http://www.pharmacy.technoastra.com/" title="">Home</a>
                                    <!-- /.sub-menu -->
                                </li>
                                            <!--<li>
                                                <a href="http://www.pharmacy.technoastra.com/about-care-n-cure/" title="">About Us</a>
                                                
                                            </li>-->
                                            <li>
                                                <a href="http://www.pharmacy.technoastra.com/find-us/" title="">FIND US</a>
                                                
                                            </li>
                                            
                                            <li>
                                                <a href="http://www.pharmacy.technoastra.com/med-club/" title="">MED CLUB</a>
                                            ...
                                            <li> 
                                                <a href="http://www.pharmacy.technoastra.com/news-events/"  title="">News & Events</a>
                                                
                                            </li>
                                            <li>  <a href="http://www.pharmacy.technoastra.com/promotion/"  title=""> promotion</a></li>
                                            
                                            <li>
                                                <a href="http://www.pharmacy.technoastra.com/contact-us/" title="">CONTACT US</a>
                                                <!-- /.sub-menu -->
                                            </li>
                    ...
                    <div class="col-md-12" style="border-bottom: solid 1px #136bcc; background:#f9f6f6; padding-top:20px;">
                        ...
                        <div class="flat-contact-form" style="padding:0px; margin-top:0px;">
                            <form id=""  method="post" action="" class="form-info">
                                <div class="field-row">
                                    <div class="one-three">
                                        <p class="input-info"><select data-trigger="" name="Location">
                                    ...
                                    <div class="one-three">
                                       <p class="input-info"><select data-trigger="" name="Showroom">
                                        <option placeholder="" value="">Showroom</option>
                                        <option>Showroom A</option>
                                        <option>Showroom B</option>
                                    </select></p>
                                </div>
                                <div class="one-three">
                                   <p class="input-info"><select data-trigger="" name="Working Time">
                                    <option placeholder="" value="">Working Time</option>
                        ...
                        <div class="btn-submit">
                            <button type="submit">FIND US</button>
                        </div>
                    </form> <!-- /.flat-form-info -->
                </div>
            </div> <!-- /.col-md-12 -->
                ...
                <div class="services-content-tab" style="width:100%;">
                        ...
                        <div class="one-half">
                            <div class="text-services">
                                ...
                                <div class="widget-map">
                                    ...
                                    <ul class="">
                                        <li class="address">
                                            CARE N CURE ABU HAMOUR PHARMACY<br>
                                            At Abu Hamour Petrol station
                                        </li>
                                        <li class="phone">
                                            +974 44 124 711
                                        </li>
                                    ...
                                    <li class="clock"><img src="http://www.pharmacy.technoastra.com/wp-content/themes/carencure/images/24icon.png" alt="">
                    ...
                    <div class="related-post">
                        <div class="flat-title">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1804.4824524574628!2d51.4993385!3d25.238107!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e45d016a4d24151%3A0x1162d08b3c755e24!2sCare+n+Cure+Pharmacy!5e0!3m2!1sen!2sqa!4v1540381983033" width="100%" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
