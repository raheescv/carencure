                    ...
                    <div class="col-md-12" style="border-bottom: solid 1px #136bcc; background:#f9f6f6; padding-top:20px;">
                        ...
                        <div class="flat-contact-form" style="padding:0px; margin-top:0px;">
                            <ul class="nav nav-tabs">
                              <li class="active"><a data-toggle="tab" href="#Location_tab">Location</a></li>
                              <li><a data-toggle="tab" href="#Showroom_tab">Showroom</a></li>
                              <li><a data-toggle="tab" href="#Pharmacy_tab">Pharmacy</a></li>
                          </ul>
...
<script type="text/javascript">
    ...
    var PharmacydataTable=$('#PharmacydataTable').dataTable();
</script>
</script>
